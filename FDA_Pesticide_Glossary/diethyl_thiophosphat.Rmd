...
printfopen3d()\n
printfdiethyl_thiophosphat<-read.table("diethyl_thiophosphat.xyz")\n
printfx<-diethyl_thiophosphat$V2\n
printfy<-diethyl_thiophosphat$V3\n
printfz<-diethyl_thiophosphat$V4\n
