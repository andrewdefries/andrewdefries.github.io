...
printfopen3d()\n
printfAntimony_Potassium_T<-read.table("Antimony_Potassium_T.xyz")\n
printfx<-Antimony_Potassium_T$V2\n
printfy<-Antimony_Potassium_T$V3\n
printfz<-Antimony_Potassium_T$V4\n
