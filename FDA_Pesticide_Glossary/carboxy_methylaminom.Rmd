...
printfopen3d()\n
printfcarboxy_methylaminom<-read.table("carboxy_methylaminom.xyz")\n
printfx<-carboxy_methylaminom$V2\n
printfy<-carboxy_methylaminom$V3\n
printfz<-carboxy_methylaminom$V4\n
