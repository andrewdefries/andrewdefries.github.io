...
printfopen3d()\n
printf4,4'-dichlorobenzoph<-read.table("4,4'-dichlorobenzoph.xyz")\n
printfx<-4,4'-dichlorobenzoph$V2\n
printfy<-4,4'-dichlorobenzoph$V3\n
printfz<-4,4'-dichlorobenzoph$V4\n
