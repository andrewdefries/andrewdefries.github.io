...
printfopen3d()\n
printfdimethyl_phosphorodi<-read.table("dimethyl_phosphorodi.xyz")\n
printfx<-dimethyl_phosphorodi$V2\n
printfy<-dimethyl_phosphorodi$V3\n
printfz<-dimethyl_phosphorodi$V4\n
