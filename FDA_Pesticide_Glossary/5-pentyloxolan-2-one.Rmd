...
printfopen3d()\n
printf5-pentyloxolan-2-one<-read.table("5-pentyloxolan-2-one.xyz")\n
printfx<-5-pentyloxolan-2-one$V2\n
printfy<-5-pentyloxolan-2-one$V3\n
printfz<-5-pentyloxolan-2-one$V4\n
