...
printfopen3d()\n
printfaminoethyl_phosphoro<-read.table("aminoethyl_phosphoro.xyz")\n
printfx<-aminoethyl_phosphoro$V2\n
printfy<-aminoethyl_phosphoro$V3\n
printfz<-aminoethyl_phosphoro$V4\n
