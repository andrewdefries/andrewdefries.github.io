...
printfopen3d()\n
printf3-ethoxycarbonylamin<-read.table("3-ethoxycarbonylamin.xyz")\n
printfx<-3-ethoxycarbonylamin$V2\n
printfy<-3-ethoxycarbonylamin$V3\n
printfz<-3-ethoxycarbonylamin$V4\n
