...
printfopen3d()\n
printfmethylcyclopropaneca<-read.table("methylcyclopropaneca.xyz")\n
printfx<-methylcyclopropaneca$V2\n
printfy<-methylcyclopropaneca$V3\n
printfz<-methylcyclopropaneca$V4\n
