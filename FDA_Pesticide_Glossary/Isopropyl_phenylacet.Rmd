...
printfopen3d()\n
printfIsopropyl_phenylacet<-read.table("Isopropyl_phenylacet.xyz")\n
printfx<-Isopropyl_phenylacet$V2\n
printfy<-Isopropyl_phenylacet$V3\n
printfz<-Isopropyl_phenylacet$V4\n
