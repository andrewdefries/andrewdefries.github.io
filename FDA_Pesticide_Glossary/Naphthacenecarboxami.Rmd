...
printfopen3d()\n
printfNaphthacenecarboxami<-read.table("Naphthacenecarboxami.xyz")\n
printfx<-Naphthacenecarboxami$V2\n
printfy<-Naphthacenecarboxami$V3\n
printfz<-Naphthacenecarboxami$V4\n
