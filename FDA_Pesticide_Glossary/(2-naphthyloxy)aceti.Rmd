...
printfopen3d()\n
printf(2-naphthyloxy)aceti<-read.table("(2-naphthyloxy)aceti.xyz")\n
printfx<-(2-naphthyloxy)aceti$V2\n
printfy<-(2-naphthyloxy)aceti$V3\n
printfz<-(2-naphthyloxy)aceti$V4\n
