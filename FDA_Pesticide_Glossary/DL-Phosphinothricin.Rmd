...
printfopen3d()\n
printfDL-Phosphinothricin<-read.table("DL-Phosphinothricin.xyz")\n
printfx<-DL-Phosphinothricin$V2\n
printfy<-DL-Phosphinothricin$V3\n
printfz<-DL-Phosphinothricin$V4\n
