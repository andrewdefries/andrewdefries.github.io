...
printfopen3d()\n
printfacetyl(methyl)carbam<-read.table("acetyl(methyl)carbam.xyz")\n
printfx<-acetyl(methyl)carbam$V2\n
printfy<-acetyl(methyl)carbam$V3\n
printfz<-acetyl(methyl)carbam$V4\n
