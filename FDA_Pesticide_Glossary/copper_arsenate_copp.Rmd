...
printfopen3d()\n
printfcopper_arsenate_copp<-read.table("copper_arsenate_copp.xyz")\n
printfx<-copper_arsenate_copp$V2\n
printfy<-copper_arsenate_copp$V3\n
printfz<-copper_arsenate_copp$V4\n
