...
printfopen3d()\n
printfarsenate_lead_arsena<-read.table("arsenate_lead_arsena.xyz")\n
printfx<-arsenate_lead_arsena$V2\n
printfy<-arsenate_lead_arsena$V3\n
printfz<-arsenate_lead_arsena$V4\n
