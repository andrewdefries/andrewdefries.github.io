...
printfopen3d()\n
printfmethyl_sulfide_methy<-read.table("methyl_sulfide_methy.xyz")\n
printfx<-methyl_sulfide_methy$V2\n
printfy<-methyl_sulfide_methy$V3\n
printfz<-methyl_sulfide_methy$V4\n
