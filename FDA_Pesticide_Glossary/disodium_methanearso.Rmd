...
printfopen3d()\n
printfdisodium_methanearso<-read.table("disodium_methanearso.xyz")\n
printfx<-disodium_methanearso$V2\n
printfy<-disodium_methanearso$V3\n
printfz<-disodium_methanearso$V4\n
