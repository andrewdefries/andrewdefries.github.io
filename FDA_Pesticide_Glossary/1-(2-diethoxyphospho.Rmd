...
printfopen3d()\n
printf1-(2-diethoxyphospho<-read.table("1-(2-diethoxyphospho.xyz")\n
printfx<-1-(2-diethoxyphospho$V2\n
printfy<-1-(2-diethoxyphospho$V3\n
printfz<-1-(2-diethoxyphospho$V4\n
