...
printfopen3d()\n
printfdichloropropane_prop<-read.table("dichloropropane_prop.xyz")\n
printfx<-dichloropropane_prop$V2\n
printfy<-dichloropropane_prop$V3\n
printfz<-dichloropropane_prop$V4\n
