...
printfopen3d()\n
printfmethanearsonic_acid_<-read.table("methanearsonic_acid_.xyz")\n
printfx<-methanearsonic_acid_$V2\n
printfy<-methanearsonic_acid_$V3\n
printfz<-methanearsonic_acid_$V4\n
