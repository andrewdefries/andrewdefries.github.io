...
printfopen3d()\n
printfO,O-di-methyl_phosph<-read.table("O,O-di-methyl_phosph.xyz")\n
printfx<-O,O-di-methyl_phosph$V2\n
printfy<-O,O-di-methyl_phosph$V3\n
printfz<-O,O-di-methyl_phosph$V4\n
