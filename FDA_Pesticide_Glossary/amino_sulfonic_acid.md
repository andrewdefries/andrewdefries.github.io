...
printfopen3d()\n
printfamino_sulfonic_acid<-read.table("amino_sulfonic_acid.xyz")\n
printfx<-amino_sulfonic_acid$V2\n
printfy<-amino_sulfonic_acid$V3\n
printfz<-amino_sulfonic_acid$V4\n
