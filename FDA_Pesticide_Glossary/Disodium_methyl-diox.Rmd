...
printfopen3d()\n
printfDisodium_methyl-diox<-read.table("Disodium_methyl-diox.xyz")\n
printfx<-Disodium_methyl-diox$V2\n
printfy<-Disodium_methyl-diox$V3\n
printfz<-Disodium_methyl-diox$V4\n
