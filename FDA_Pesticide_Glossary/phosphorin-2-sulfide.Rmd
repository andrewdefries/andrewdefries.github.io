...
printfopen3d()\n
printfphosphorin-2-sulfide<-read.table("phosphorin-2-sulfide.xyz")\n
printfx<-phosphorin-2-sulfide$V2\n
printfy<-phosphorin-2-sulfide$V3\n
printfz<-phosphorin-2-sulfide$V4\n
