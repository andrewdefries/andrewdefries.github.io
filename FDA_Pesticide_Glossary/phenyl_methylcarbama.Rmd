...
printfopen3d()\n
printfphenyl_methylcarbama<-read.table("phenyl_methylcarbama.xyz")\n
printfx<-phenyl_methylcarbama$V2\n
printfy<-phenyl_methylcarbama$V3\n
printfz<-phenyl_methylcarbama$V4\n
