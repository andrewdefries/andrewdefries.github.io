...
printfopen3d()\n
printfchlorosulfamic_acid<-read.table("chlorosulfamic_acid.xyz")\n
printfx<-chlorosulfamic_acid$V2\n
printfy<-chlorosulfamic_acid$V3\n
printfz<-chlorosulfamic_acid$V4\n
