...
printfopen3d()\n
printfPhenylcarbamic_Acid_<-read.table("Phenylcarbamic_Acid_.xyz")\n
printfx<-Phenylcarbamic_Acid_$V2\n
printfy<-Phenylcarbamic_Acid_$V3\n
printfz<-Phenylcarbamic_Acid_$V4\n
