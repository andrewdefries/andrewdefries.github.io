...
printfopen3d()\n
printfOC1(C(OC)_O)c3c(ccc(<-read.table("OC1(C(OC)_O)c3c(ccc(.xyz")\n
printfx<-OC1(C(OC)_O)c3c(ccc($V2\n
printfy<-OC1(C(OC)_O)c3c(ccc($V3\n
printfz<-OC1(C(OC)_O)c3c(ccc($V4\n
