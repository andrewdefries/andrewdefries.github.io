...
printfopen3d()\n
printfN-_isopropylphosphor<-read.table("N-_isopropylphosphor.xyz")\n
printfx<-N-_isopropylphosphor$V2\n
printfy<-N-_isopropylphosphor$V3\n
printfz<-N-_isopropylphosphor$V4\n
