...
printfopen3d()\n
printfindeno(1,2-b)oxirane<-read.table("indeno(1,2-b)oxirane.xyz")\n
printfx<-indeno(1,2-b)oxirane$V2\n
printfy<-indeno(1,2-b)oxirane$V3\n
printfz<-indeno(1,2-b)oxirane$V4\n
