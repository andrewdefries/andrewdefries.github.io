...
printfopen3d()\n
printf1-methylethyl_(3,4-d<-read.table("1-methylethyl_(3,4-d.xyz")\n
printfx<-1-methylethyl_(3,4-d$V2\n
printfy<-1-methylethyl_(3,4-d$V3\n
printfz<-1-methylethyl_(3,4-d$V4\n
