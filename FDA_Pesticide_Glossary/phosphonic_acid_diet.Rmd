...
printfopen3d()\n
printfphosphonic_acid_diet<-read.table("phosphonic_acid_diet.xyz")\n
printfx<-phosphonic_acid_diet$V2\n
printfy<-phosphonic_acid_diet$V3\n
printfz<-phosphonic_acid_diet$V4\n
