...
printfopen3d()\n
printfN-(Mercaptomethyl)ph<-read.table("N-(Mercaptomethyl)ph.xyz")\n
printfx<-N-(Mercaptomethyl)ph$V2\n
printfy<-N-(Mercaptomethyl)ph$V3\n
printfz<-N-(Mercaptomethyl)ph$V4\n
