...
printfopen3d()\n
printfcarboxyl,_thioureido<-read.table("carboxyl,_thioureido.xyz")\n
printfx<-carboxyl,_thioureido$V2\n
printfy<-carboxyl,_thioureido$V3\n
printfz<-carboxyl,_thioureido$V4\n
