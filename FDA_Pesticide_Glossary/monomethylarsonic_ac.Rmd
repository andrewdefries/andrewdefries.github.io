...
printfopen3d()\n
printfmonomethylarsonic_ac<-read.table("monomethylarsonic_ac.xyz")\n
printfx<-monomethylarsonic_ac$V2\n
printfy<-monomethylarsonic_ac$V3\n
printfz<-monomethylarsonic_ac$V4\n
