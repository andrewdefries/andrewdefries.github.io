...
printfopen3d()\n
printfdimethyl(thiocarbama<-read.table("dimethyl(thiocarbama.xyz")\n
printfx<-dimethyl(thiocarbama$V2\n
printfy<-dimethyl(thiocarbama$V3\n
printfz<-dimethyl(thiocarbama$V4\n
