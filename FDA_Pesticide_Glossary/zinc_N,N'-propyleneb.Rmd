...
printfopen3d()\n
printfzinc_N,N'-propyleneb<-read.table("zinc_N,N'-propyleneb.xyz")\n
printfx<-zinc_N,N'-propyleneb$V2\n
printfy<-zinc_N,N'-propyleneb$V3\n
printfz<-zinc_N,N'-propyleneb$V4\n
