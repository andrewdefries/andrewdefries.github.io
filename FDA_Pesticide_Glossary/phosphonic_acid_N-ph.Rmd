...
printfopen3d()\n
printfphosphonic_acid_N-ph<-read.table("phosphonic_acid_N-ph.xyz")\n
printfx<-phosphonic_acid_N-ph$V2\n
printfy<-phosphonic_acid_N-ph$V3\n
printfz<-phosphonic_acid_N-ph$V4\n
