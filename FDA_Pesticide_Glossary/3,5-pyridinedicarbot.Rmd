...
printfopen3d()\n
printf3,5-pyridinedicarbot<-read.table("3,5-pyridinedicarbot.xyz")\n
printfx<-3,5-pyridinedicarbot$V2\n
printfy<-3,5-pyridinedicarbot$V3\n
printfz<-3,5-pyridinedicarbot$V4\n
