...
printfopen3d()\n
printfpyrazol-5-yl_toluene<-read.table("pyrazol-5-yl_toluene.xyz")\n
printfx<-pyrazol-5-yl_toluene$V2\n
printfy<-pyrazol-5-yl_toluene$V3\n
printfz<-pyrazol-5-yl_toluene$V4\n
