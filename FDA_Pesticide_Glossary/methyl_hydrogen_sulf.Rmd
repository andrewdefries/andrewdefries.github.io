...
printfopen3d()\n
printfmethyl_hydrogen_sulf<-read.table("methyl_hydrogen_sulf.xyz")\n
printfx<-methyl_hydrogen_sulf$V2\n
printfy<-methyl_hydrogen_sulf$V3\n
printfz<-methyl_hydrogen_sulf$V4\n
