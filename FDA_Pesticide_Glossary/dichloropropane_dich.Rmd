...
printfopen3d()\n
printfdichloropropane_dich<-read.table("dichloropropane_dich.xyz")\n
printfx<-dichloropropane_dich$V2\n
printfy<-dichloropropane_dich$V3\n
printfz<-dichloropropane_dich$V4\n
