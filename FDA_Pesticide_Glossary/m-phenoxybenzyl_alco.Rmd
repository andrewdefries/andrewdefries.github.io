...
printfopen3d()\n
printfm-phenoxybenzyl_alco<-read.table("m-phenoxybenzyl_alco.xyz")\n
printfx<-m-phenoxybenzyl_alco$V2\n
printfy<-m-phenoxybenzyl_alco$V3\n
printfz<-m-phenoxybenzyl_alco$V4\n
