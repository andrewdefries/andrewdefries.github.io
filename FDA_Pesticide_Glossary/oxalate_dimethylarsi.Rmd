...
printfopen3d()\n
printfoxalate_dimethylarsi<-read.table("oxalate_dimethylarsi.xyz")\n
printfx<-oxalate_dimethylarsi$V2\n
printfy<-oxalate_dimethylarsi$V3\n
printfz<-oxalate_dimethylarsi$V4\n
