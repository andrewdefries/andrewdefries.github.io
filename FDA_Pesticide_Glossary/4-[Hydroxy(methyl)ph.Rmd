...
printfopen3d()\n
printf4-[Hydroxy(methyl)ph<-read.table("4-[Hydroxy(methyl)ph.xyz")\n
printfx<-4-[Hydroxy(methyl)ph$V2\n
printfy<-4-[Hydroxy(methyl)ph$V3\n
printfz<-4-[Hydroxy(methyl)ph$V4\n
