...
printfopen3d()\n
printfdibromochloropropane<-read.table("dibromochloropropane.xyz")\n
printfx<-dibromochloropropane$V2\n
printfy<-dibromochloropropane$V3\n
printfz<-dibromochloropropane$V4\n
