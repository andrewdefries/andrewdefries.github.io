...
printfopen3d()\n
printf1-naphthylacetic_aci<-read.table("1-naphthylacetic_aci.xyz")\n
printfx<-1-naphthylacetic_aci$V2\n
printfy<-1-naphthylacetic_aci$V3\n
printfz<-1-naphthylacetic_aci$V4\n
